...
#    skeleton = 'mpi_inf_3dhp_28'
    ...
    with open('debugoutput.txt', 'w') as f:
     ...
     for i in range ( frame_start , frame_end , frame_skip):
      ...
      print('in->',name,'max_detections',max_detections,'progress',progress)
      ...
      if (memratio > max_blowup) :
      	print(msgbarstart+'Blowup limit at',i,msgbarend)
      	return
      ...
      try:
        ...
        print(msgbarstart,file=f)
        print('detect_poses bailed out','max_detections',max_detections,file=f)
        if max_detections > 1:
          print('retry with 1',file=f)
          try:
            print(msgbarstart,file=f)
